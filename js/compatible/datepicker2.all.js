  ...
  $.extend(Day.prototype, {
    ...
    eventSingle: function () {
      ...
      function setValue(activeNum, input, inputDay) {
        ...
        //   sessionStorage.setItem("STime01",val)
        // }
        //   if(this.picker.$container.index() == "14"){
        //       sessionStorage.setItem("ETime01",val)
        //   }
        //
        //   var Type = sessionStorage.getItem("Type01");
        //   var STime = sessionStorage.getItem("STime01");
        //   var ETime = sessionStorage.getItem("ETime01");
